...
path_param.time_vec = [0,3,5];
path_param.linear_velocity.q  = [0.1,0.1,0.1]; % offset
path_param.linear_velocity.m  = [0,0,0]; %slope
path_param.angular_velocity.q = [0.1,0.3,0.1];% punt mootonic increase in omega, otherwise we have unconvergence due to the zero crossing 
